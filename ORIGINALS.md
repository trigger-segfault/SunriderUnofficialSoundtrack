...
These tracks were all likely made available through the Sunrider Kickstarter campaigns. However they can still be obtained using tracks and OP videos from the game data.
...
|`[X]`<br><kbd>MoA</kbd> <kbd>ED</kbd> <kbd>full</kbd> <kbd>inst</kbd>|Firn -The Pale Sun-<br><sup>(feat. lily-an & Maya) [game size]</sup>|Iced Blade|[<sub>![][Storenvy]</sub> Storenvy](https://amasawakobo.storenvy.com/products/25367223-hd-dl-sunrider-bundle) <kbd>DL(HD)</kbd><br>[<sub>![][Storenvy]</sub> Storenvy](https://amasawakobo.storenvy.com/products/8309646-cd-dl-iced-blade-sora-no-senritsu-with-hd-download) <kbd>CD</kbd>+<kbd>DL(HD)</kbd><br>[<sub>![][Storenvy]</sub> Storenvy](https://amasawakobo.storenvy.com/products/8308866-cd-iced-blade-sora-no-senritsu) <kbd>CD</kbd><br>[<sub>![][Amazon]</sub> Amazon](https://www.amazon.com/Sora-No-Senritsu-Melody-Cosmos/dp/B01BZA44KU) <kbd>CD</kbd>
...
|`opening.avi`<br><kbd>SA</kbd> <kbd>OP</kbd> <kbd>cut</kbd> <kbd>video</kbd>|Stardust Tears<br><sup>(game size)</sup>|myu|<kbd>Game Data Only</kbd>
...
<!--
1. 宙の旋律(Sora no Senritsu) -the melody of the cosmos- feat.lily-an
2. Chiru Hana feat.lily-an
3. Firn -The Pale Sun- feat.lily-an / 麻也(Maya)
4. Lost History feat.Sola(CV.Tina Kim)
5. 宙の旋律(Sora no Senritsu) -the melody of the cosmos- feat.lily-an (OP Cut)
6. Clear Wing feat.麻也(Maya) (Bonus Track)
7. Scarlet ～月に吠える～ feat.黒崎朔夜(Kurosaki Sakuya) (Bonus Track)
8. 宙の旋律(Sora no Senritsu) -the melody of the cosmos- feat.lily-an (instrumental)
9. Chiru Hana feat.lily-an (instrumental)
10. Firn -The Pale Sun- feat.lily-an / 麻也(Maya) (instrumental)
11. Lost History feat.Sola(CV.Tina Kim) (instrumental)
-->
